...
export default function StaffLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!loading) {
      if (!user) {
        ...
        // Admins can access staff area, but maybe they shouldn't be forced out.
        // Let's just ensure they are logged in.
      }
    }
  ...
  return (
    <div className="flex h-screen bg-slate-50 relative overflow-hidden">
      ...
      <Sidebar role="staff" isMobileMenuOpen={isMobileMenuOpen} setIsMobileMenuOpen={setIsMobileMenuOpen} />
